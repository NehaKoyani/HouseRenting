...
public class addHouse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add Property Detail");
        ...
        jLabel7.setText("Property Information");
    ...
    private void rSMaterialButtonRectangle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonRectangle1ActionPerformed
        ...
        if(ownerid.equals("")){
            ...
            try{
                ...
                PreparedStatement p=con.prepareStatement("insert into house_info(id,owner_name,h_type,sqft,address,rent,status,city) values(?,?,?,?,?,?,?,?)");
                p.setString(1,ownerid);
                p.setString(2,ownername);
                p.setString(3,type);
                p.setString(4,sqft);
                p.setString(5,address);
                p.setString(6,rent);
                p.setString(7,"available");
                p.setString(8,city);
                p.execute();
    ...
    private void rSTableMetro2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rSTableMetro2MouseClicked
        ...
        jLabel8.setText(model1.getValueAt(rowNo, 5).toString());
