...
public class addOwner extends javax.swing.JFrame {
    ...
    private void rSMaterialButtonRectangle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonRectangle1ActionPerformed
        ...
        else if(email.equals(""))
        {
            ...
            try{
                Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/house_renting","root","root");
                PreparedStatement p=con.prepareStatement("insert into owner_info(username,contact,email,age,area,status) values(?,?,?,?,?,?)");
